...
export default function LifestyleSection() {
  const lifestyleCards = [
    { 
      id: 'the-creator-economy-is-now-worth-over-250-billion',
      image: 'https://picsum.photos/seed/creator-economy/600/400', 
      badge: 'BUSINESS', 
    ...
    { 
      id: 'e-commerce-growth-in-west-africa-opportunities-and-challenges',
      image: 'https://picsum.photos/seed/ecommerce-africa/600/400', 
      badge: 'BUSINESS', 
    ...
    { 
      id: 'the-science-behind-a-good-nights-sleep-and-why-it-matters',
      image: 'https://picsum.photos/seed/sleep-science/600/400', 
      badge: 'HEALTH', 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {lifestyleCards.map((card, idx) => (
          <Link to={`/post/${card.id}`} key={idx} className="group cursor-pointer block">
            ...
            <h3 className="font-bold text-lg mb-2 group-hover:text-brand-secondary transition-colors leading-snug">{card.title}</h3>
